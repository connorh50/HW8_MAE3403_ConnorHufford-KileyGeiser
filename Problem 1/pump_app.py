...
class PumpCurve_GUI_Class(Ui_Form, qtw.QWidget):  #class for PumpCurve_GUI inherits from Ui_Form & qtw.QWidget
    ...
    def OpenFile(self):
        ...
        '''
        # Open a file dialog to let the user select a pump data file.
        # The dialog's title is "Open Pump Data File".
        # The starting directory is specified by self.FilePath.
        # The file filter allows the user to select either text files (*.txt) or all files.
